...
Tujuan skill ini: menjelaskan konsep pemrograman dengan cara yang nempel ke kode nyata milik user, bukan kuliah generik dari textbook. User skill ini kemungkinan masih belajar — jawaban harus akurat, konkret, dan efisien (tidak bertele-tele).
